...
# Initialize Firebase
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "ragmodel-2d8c9-firebase-adminsdk-1j0ip-8592022f53.json"
cred = credentials.Certificate("ragmodel-2d8c9-firebase-adminsdk-1j0ip-8592022f53.json")
# initialize_app(cred)

pc = Pinecone(
    api_key="69b43807-1b2e-47ca-83c2-3031211f3e5c"
)
index_name = 'ragchat786'
